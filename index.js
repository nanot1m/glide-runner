...
// include: /var/folders/36/cs64lmq14dndz9t674ts9j7r0000gn/T/tmp5ibmx35j.js
...
Module['FS_createPath']("/", "levels", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/death.wav", "start": 0, "end": 55574, "audio": 1}, {"filename": "/assets/hover.wav", "start": 55574, "end": 173244, "audio": 1}, {"filename": "/assets/jump.wav", "start": 173244, "end": 210920, "audio": 1}, {"filename": "/assets/menu.mp3", "start": 210920, "end": 783523, "audio": 1}, {"filename": "/assets/menu.wav", "start": 783523, "end": 901193, "audio": 1}, {"filename": "/assets/victory.wav", "start": 901193, "end": 1048447, "audio": 1}, {"filename": "/config/input.cfg", "start": 1048447, "end": 1048797}, {"filename": "/levels/level1.lvl", "start": 1048797, "end": 1050022}, {"filename": "/levels/level2.lvl", "start": 1050022, "end": 1051247}, {"filename": "/levels/level3.lvl", "start": 1051247, "end": 1052472}], "remote_package_size": 1052472});

  })();

// end include: /var/folders/36/cs64lmq14dndz9t674ts9j7r0000gn/T/tmp5ibmx35j.js
// include: /var/folders/36/cs64lmq14dndz9t674ts9j7r0000gn/T/tmpd_bkekg3.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/36/cs64lmq14dndz9t674ts9j7r0000gn/T/tmpd_bkekg3.js
// include: /var/folders/36/cs64lmq14dndz9t674ts9j7r0000gn/T/tmp5w10cb39.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/36/cs64lmq14dndz9t674ts9j7r0000gn/T/tmp5w10cb39.js
...
var ASM_CONSTS = {
  131792: () => { if (document.fullscreenElement) return 1; },  
 131838: () => { return Module.canvas.width; },  
 131870: () => { return parseInt(Module.canvas.style.width); },  
 131918: () => { document.exitFullscreen(); },  
 131945: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 132018: () => { if (document.fullscreenElement) return 1; },  
 132064: () => { return Module.canvas.width; },  
 132096: () => { return screen.width; },  
 132121: () => { document.exitFullscreen(); },  
 132148: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 132281: () => { return window.innerWidth; },  
 132307: () => { return window.innerHeight; },  
 132334: () => { if (document.fullscreenElement) return 1; },  
 132380: () => { return Module.canvas.width; },  
 132412: () => { return parseInt(Module.canvas.style.width); },  
 132460: () => { if (document.fullscreenElement) return 1; },  
 132506: () => { return Module.canvas.width; },  
 132538: () => { return screen.width; },  
 132563: () => { return window.innerWidth; },  
 132589: () => { return window.innerHeight; },  
 132616: () => { if (document.fullscreenElement) return 1; },  
 132662: () => { return Module.canvas.width; },  
 132694: () => { return screen.width; },  
 132719: () => { document.exitFullscreen(); },  
 132746: () => { if (document.fullscreenElement) return 1; },  
 132792: () => { return Module.canvas.width; },  
 132824: () => { return parseInt(Module.canvas.style.width); },  
 132872: () => { document.exitFullscreen(); },  
 132899: ($0) => { Module.canvas.style.opacity = $0; },  
 132937: () => { return screen.width; },  
 132962: () => { return screen.height; },  
 132988: () => { return window.screenX; },  
 133015: () => { return window.screenY; },  
 133042: () => { return window.devicePixelRatio; },  
 133078: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 133131: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 133182: () => { Module.canvas.style.cursor = 'none'; },  
 133219: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 133475: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 133526: () => { if (document.pointerLockElement) return 1; },  
 133573: () => { if (document.fullscreenElement) return 1; },  
 133619: () => { return window.innerWidth; },  
 133645: () => { return window.innerHeight; },  
 133672: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; let miniaudio = window.miniaudio; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === miniaudio.device_state.started) { device.webaudio.resume().then(() => { _ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 135850: () => { if (typeof(window.miniaudio) !== 'undefined') { miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 136140: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 136244: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 136415: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == window.miniaudio.device_type.playback || deviceType == window.miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == window.miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return window.miniaudio.track_device(device); },  
 139292: ($0) => { return window.miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 139365: ($0) => { var device = window.miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 139765: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 139815: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 139954: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; }
};
