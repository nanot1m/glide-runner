...
// include: /var/folders/36/cs64lmq14dndz9t674ts9j7r0000gn/T/tmp0ni8r1jy.js
...
// end include: /var/folders/36/cs64lmq14dndz9t674ts9j7r0000gn/T/tmp0ni8r1jy.js
// include: /var/folders/36/cs64lmq14dndz9t674ts9j7r0000gn/T/tmpurwp8ujj.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/36/cs64lmq14dndz9t674ts9j7r0000gn/T/tmpurwp8ujj.js
// include: /var/folders/36/cs64lmq14dndz9t674ts9j7r0000gn/T/tmp6fywwg2d.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/36/cs64lmq14dndz9t674ts9j7r0000gn/T/tmp6fywwg2d.js
...
var ASM_CONSTS = {
 ...
 139863: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 139913: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 140052: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; }
};
function ensure_canvas_focus() { if (typeof Module !== 'undefined' && Module.canvas) { Module.canvas.tabIndex = 0; if (document.activeElement !== Module.canvas) Module.canvas.focus(); } }
